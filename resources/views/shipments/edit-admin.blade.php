                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('shipments.update-status', $shipment) }}" method="POST" id="monitoringForm">
                        ...
                        <div class="flex justify-end space-x-4 pt-4">
                            <a href="{{ route('shipments.show', $shipment) }}" class="bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 font-bold py-2 px-6 rounded transition shadow-sm">
                                {{ __('Cancel') }}
                            </a>
