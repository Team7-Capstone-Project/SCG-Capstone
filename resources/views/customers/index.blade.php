    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            @can('create', App\Models\Customer::class)
                <a href="{{ route('customers.create') }}" class="bg-scg-red dark:bg-red-600 hover:bg-red-800 dark:hover:bg-red-500 text-white font-bold py-2 px-4 rounded transition shadow-sm">
                    + {{ __('Create Customer') }}
                </a>
            @endcan
        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-scg-gray-light dark:bg-gray-700">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-scg-gray-dark dark:text-gray-200 uppercase">{{ __('Customer') }}</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($customers as $customer)
                                        <tr onclick="window.location='{{ route('customers.show', $customer) }}'" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150 cursor-pointer">
