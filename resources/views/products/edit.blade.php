    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">{{ $product->sku }} — {{ $product->name }}</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                            ...
                            <div class="p-5">
                                <div id="image-upload-area" 
                                    ...
                                    {{-- Preview (shows current image or new upload) --}}
                                    <div id="image-preview" class="{{ $product->image ? '' : 'hidden' }} absolute inset-0">
                                        <img id="preview-img" src="{{ $product->image_url }}" alt="{{ $product->name }}" class="w-full h-full object-cover">
                                    ...
                                    {{-- Upload Placeholder --}}
                                    <div id="upload-placeholder" class="{{ $product->image ? 'hidden' : '' }} flex flex-col items-center justify-center h-full p-6 text-center">
                                ...
                                @if($product->image)
                                    <div class="mt-3 flex items-center gap-2">
                                        <input type="checkbox" name="remove_image" id="remove_image" value="1"
                                               class="rounded border-gray-300 dark:border-gray-600 text-scg-red focus:ring-scg-red/20">
                                        <label for="remove_image" class="text-sm text-gray-600 dark:text-gray-400">{{ __('Remove current image') }}</label>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                        ...
                                        placeholder="{{ __('Describe your product...') }}">{{ old('description', $product->description) }}</textarea>
                                </div>
