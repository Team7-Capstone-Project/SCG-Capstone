        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-scg-gray-light">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-scg-gray-dark uppercase">Country</th>
                                    ...
                                    @foreach($suppliers as $supplier)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                <a href="{{ route('suppliers.show', $supplier) }}" class="text-scg-red hover:text-red-900">View</a>
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8">No suppliers found.</p>
                    @endif
                </div>
            </div>
        </div>
